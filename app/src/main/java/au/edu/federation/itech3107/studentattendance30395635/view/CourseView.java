package au.edu.federation.itech3107.studentattendance30395635.view;
...
public class CourseView extends FrameLayout {
    ...
    /** The width of the row item is automatically evenly distributed
     * according to the total width of the view */
